    ...
    return (
        <div className="banner-ad" onClick={setCodeNum}>
            ...
            <h2 className="banner-ad__head">
                Get  Your <span className="banner-ad__head__price">10%</span>  OFF
            </h2>
            <h3 className="banner-ad__title">BRAZILIAN JIU JITSU MONTH</h3>
            <p className="banner-ad__code">Generate code on "Click" </p>
            <h4>{(bannerCode === ' ') ? 'Bad code! Try Again' : bannerCode}</h4>
            <p className="banner-ad__code">Just scan or take picture and show us on training</p>
        </div>
    )
}
